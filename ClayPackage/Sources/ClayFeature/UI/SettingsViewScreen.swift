    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Panel(title: "Preferences") {
                ...
                SimpleToggle(label: "Animated Backgrounds", isOn: Binding(
                    get: { engine.state.settings.animatedBackgroundsEnabled },
                    set: { engine.setAnimatedBackgroundsEnabled($0) }
                ), identifier: "toggle_animated_backgrounds")
                Text("Reduce Motion also disables animation.")
